...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -784.2594920945485; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1713.4973093221427; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 360.50061611241586; // x position of the perpendicular encoder (in tick units)
    }
