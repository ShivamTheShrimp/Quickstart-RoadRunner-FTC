...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -662.2368723549088; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 444.5168195561296; // x position of the perpendicular encoder (in tick units)
    }
